/**
 * COMPONENTE: StatisticsChart
 * FUNCIÓN TRIBUTARIA: Gráfico comparativo temporal para contrastar la emisión de comprobantes
 * frente a los ingresos netos (base imponible) percibidos en cada período fiscal.
 */
import { useEffect, useRef } from "react";
import Chart from "react-apexcharts";
import { ApexOptions } from "apexcharts";
import flatpickr from "flatpickr";
import ChartTab from "../comunes/PestanaGrafica";
import { CalenderIcon } from "../../iconos";
...
export default function StatisticsChart() {
  ...
  const series = [
    ...
    {
      name: "Ingresos Totales (Base Imponible)",
      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          ...
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Proyección de ingresos establecida
          </p>
        </div>
